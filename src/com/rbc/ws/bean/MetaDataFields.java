...
/**
 * <p>Java class for MetaDataFields complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MetaDataFields">
 *   &lt;complexContent>
...
@XmlType(name = "MetaDataFields", propOrder = {
    "metaDataField"
})
public class MetaDataFields {

    @XmlElement(name = "MetaDataField")
    protected List<MetaDataFieldType> metaDataField;
     ...
     * 
     */
    public List<MetaDataFieldType> getMetaDataField() {
        if (metaDataField == null) {
            metaDataField = new ArrayList<MetaDataFieldType>();
        }
